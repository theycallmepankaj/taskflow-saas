  ...
  return (
    <div className="profile-page space-y-6 sm:space-y-8 [&_h1]:m-0 [&_h2]:m-0 [&_h3]:m-0">
      <header>
        ...
        <p className="mt-1 text-sm text-zinc-500">Manage your personal information and activity.</p>
      </header>
        ...
        <div className={`${glassCard} relative overflow-hidden p-6 sm:p-8 lg:col-span-1`}>
          ...
          <div className="relative flex flex-col items-center text-center">
            ...
            {isEditing ? (
              ...
              <>
                <h2 className="mt-6 text-xl font-semibold text-white">{display.name}</h2>
                <p className="mt-1 text-sm text-cyan-300/90">{display.role}</p>
              </>
            )}
            ...
            <div className="mt-6 flex w-full flex-col gap-2.5 text-left text-sm text-zinc-500">
              ...
              <span className="flex items-center gap-2.5">
                <MapPin className="h-4 w-4 shrink-0 text-zinc-600" strokeWidth={1.75} />
                {isEditing ? (
                  <input
                    type="text"
            ...
            <div className="mt-8 flex w-full gap-2">
              {isEditing ? (
                ...
                >
                  <Pencil className="h-4 w-4 text-cyan-400" strokeWidth={1.75} />
                  Edit profile
                </button>
              )}
            </div>
        ...
        <div className="space-y-6 lg:col-span-2">
          ...
          <div className={`${glassCard} p-6 sm:p-8`}>
            ...
            {isEditing ? (
              ...
              <p className="mt-3 text-sm leading-relaxed text-zinc-400">{display.bio}</p>
            )}
          </div>

          {/* Activity stats */}
          <div>
            <h3 className="mb-4 text-base font-semibold text-white">Activity stats</h3>
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="text-sm text-zinc-300">
                      <span className="font-medium text-cyan-300/90">{item.action}</span>{' '}
